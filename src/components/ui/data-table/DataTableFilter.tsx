...
type FilterType = "select" | "checkbox" | "number" | "text"
          ...
          <div className="space-y-2">
            ...
            <div className="flex w-full items-center gap-2">
              ...
              <Input
                ...
                value={(selectedValues as ConditionFilter)?.value?.[0] || ""} // ✅ fix
                onChange={(e) => {
                  setSelectedValues((prev) => {
                    return {
                      ...
                      value: [
                        e.target.value,
                        isBetween
                          ? (prev as ConditionFilter)?.value?.[1] || ""
                          : "",
                      ],
                    }
                  })
