        ...
        <div className="space-y-6 rounded-xl bg-white px-4 py-5 md:p-12">
          ...
          <section>
            ...
            <ul className="ml-4 mt-2 list-disc space-y-3 text-sm text-gray-700">
              ...
              <li>Country refers to: Uzbekistan</li>
              <li>
                Company (referred to as either "the Company", "We", "Us" or
                "Our" in this Agreement) refers to ALTEK DIGITAL, Tashkent city,
                Zarkent 1st passage, 20/1
              </li>
              <li>
          ...
          <section>
            <h1 className="pb-3 text-xl font-bold text-gray-900 md:text-2xl">
              Acknowledgment
            </h1>
          ...
          <section>
            ...
            <ul className="list-disk space-y-3 text-sm text-gray-700">
              <li>By email: info@altek.uz</li>
              <li>By visiting this page on our website: https://altek.uz/</li>
              <li>
                By phone number: +998 (33) 330-4774
              </li>
            </ul>
          </section>
        </div>
