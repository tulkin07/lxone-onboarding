...
import { useCreateHr } from "../hooks/useCreateHr"
...
export function DrawerAddHr({
  ...
  const { create, isPending } = useCreateHr()
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    create(formData as unknown as HrFormData, {
      onSuccess: () => {
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          ...
                          <Input
                            ...
                            value={formData.exemot_payee_code}
                            onChange={handleInputChange}
                            required
                          />
                        </div>
                        <div>
                          ...
                          <Input
                            ...
                            value={formData.fatca_reporting_code}
                            onChange={handleInputChange}
                            required
                          />
                        </div>
