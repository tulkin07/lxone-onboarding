...
export function VehicleDataTable<TData extends { id: string | number }>({
  columns,
  data,
  isLoading,
}: DataTableProps<TData>) {
  const [vehicleUpdateData, setVehicleUpdateData] = React.useState<{
    id: string
  } | null>(null)
  const [openVehicleUpdateModal, setOpenVehiclUpdateModal] =
    React.useState(false)

  const onEdit = (row: any) => {
    setVehicleUpdateData(row?.original)
